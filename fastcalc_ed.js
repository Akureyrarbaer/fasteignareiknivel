...
function calculate(){
 ...
 //           result_div.innerHTML = "<h3>Heildarkostnaður: "+result+" kr.</h3><br/><h4>Mánaðarleg greiðsla febrúar-september: "+manud+" kr.</h4></br><p><strong>Sundurliðun</strong></p><p>Miðað við þær forsendur sem þú settir inn má reikna með að fasteignagjöld fyrir árið séu eftirfarandi:</p><p><strong>Fasteignaskattur:</strong> "+fastskatt+" kr.</p><p><strong>Lóðarleiga:</strong> "+lodleig+" kr.</p><p><strong>Fráveitugjald:</strong> "+fraveit+" kr.</p><p><strong>Vatnsgjald:</strong> "+vatn+" kr.</p><p><strong>Sorphirðugjald:</strong> "+sorp+" kr.</p><p><strong>Samtals: "+result+" kr.</strong></p>"
            result_div.innerHTML = "<h3><strong>Sundurliðun</strong></h3><p>Miðað við þær forsendur sem þú settir inn má reikna með að fasteignagjöld fyrir árið séu eftirfarandi:</p><p><strong>Fasteignaskattur:</strong> "+fastskatt+" kr.</p><p><strong>Lóðarleiga:</strong> "+lodleig+" kr.</p><p><strong>Fráveitugjald:</strong> "+fraveit+" kr.</p><p><strong>Vatnsgjald:</strong> "+vatn+" kr.</p><p><strong>Sorphirðugjald:</strong> "+sorp+" kr.</p><p><strong>Samtals: "+result+" kr.</strong> Þar af afsláttur vegna elli/örorku: "+discount+" kr.</p><h4><strong>Mánaðarleg greiðsla febrúar-september: "+manud+" kr.</strong></h4><p><em>Fasteignagjöld ársins eru innheimt í 8 greiðslum frá febrúar til september hvert ár.</em></p>"
         }
    }
}